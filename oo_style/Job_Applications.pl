...
sub job_applications
{
	get_slug_for_active_job_from_company_id30();
	#get_slug_for_active_job_from_company_id26();
	...
	$sel->type_ok("application_data_email", "jibeqa4567\@gmail.com", "$tmp_slug Job Page - User enters job appication contact email id");
