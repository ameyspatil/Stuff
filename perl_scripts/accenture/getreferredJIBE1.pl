...
$sel->type_ok("name", "Sham");
$sel->type_ok("email", "shampatel113\@gmail.com");
...
$sel->value_is("email", "shampatel113\@gmail.com");
$sel->click_ok("register-applicant");
...
$sel->wait_for_text_present_ok("Radhe","Check to see if the Give Referral page loads");
$sel->wait_for_text_present_ok("Sham","Check to see if the Give Referral page loads");
